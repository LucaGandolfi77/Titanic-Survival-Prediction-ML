  ...
  function finish(result, extra) {
    ...
    if (result === 'win') {
      ...
      el.innerHTML =
        ...
        '<p style="margin:12px 0">Perfect bid! Market price was €' +
        marketPrice +
        '</p>' +
        '<p>' +
        artist.emoji +
      ...
      el.innerHTML =
        ...
        '<p style="margin:12px 0;color:var(--danger)">You overpaid by €' +
        extra +
        '! Market: €' +
        marketPrice +
        '</p>' +
      ...
      el.innerHTML =
        ...
        '<p style="color:var(--gray-light);margin:12px 0">Market was €' +
        marketPrice +
        '. Try again later.</p>' +
      ...
      el.innerHTML =
        ...
        '<p style="color:var(--gray-light);margin:12px 0">You didn\'t bid in time. Market was €' +
        marketPrice +
        '</p>' +
        '<button class="btn btn-secondary" style="margin-top:16px" id="mg-done-btn">Back to Map</button>' +
        '</div>'

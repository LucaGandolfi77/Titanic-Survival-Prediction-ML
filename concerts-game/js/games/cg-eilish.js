...
G.cgEilish = function (concertId, onComplete) {
  ...
  html +=
    '<div class="cg-instruction">Hold <strong>SPACE</strong> to raise volume. Keep it in the green zone for 5 seconds!</div>'
  ...
  ctx = G.setupHDCanvas(canvas, W, H)

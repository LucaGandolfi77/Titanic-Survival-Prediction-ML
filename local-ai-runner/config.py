...
MODEL_CATALOG = [            # ── Ultra-lightweight (< 1B) ─────────────────────────────────────────────
    ...
    {
    "id":       "qwen3.5-0.8b-q4",
    "name":     "Qwen 3.5 0.8B Unsloth",
    "author":   "Alibaba (Unsloth)",
    "filename": "qwen3.5-0.8b-Q4_K_S.gguf",
    "repo_id":  "unsloth/Qwen3.5-0.8B-GGUF",
    "url":      "https://huggingface.co/unsloth/Qwen3.5-0.8B-GGUF/"
                "resolve/main/qwen3.5-0.8b-Q4_K_S.gguf", # Qwen3.5-0.8B-Q4_K_S.gguf?download=true
    "size_gb":  0.45,
    "ram_gb":   1,
    "context":  32768,
    "desc":     "Qwen3.5 0.8B GGUF by Unsloth. Very small, fast for local use.",
    "tags":     ["ultra-light", "fast", "qwen3.5"],
},
    {
        "id":       "qwen3.5-0.8b-q4",
        ...
        "url":      "https://https://huggingface.co/Qwen/Qwen3.5-0.8B-Instruct-GGUF"
                    "/resolve/main/qwen3.5-0.8b-instruct-q4_k_m.gguf",
        "size_gb":  0.80,
        "ram_gb":   2,
        "context":  32768,
        "desc":     "Compact Qwen 3.5 variant with good instruction-following at small size.",
        "tags":     ["ultra-light", "fast", "multilingual"],
    },

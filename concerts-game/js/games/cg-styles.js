...
G.cgStyles = function (concertId, onComplete) {
  ...
  html +=
    '<div id="cg-status" style="font-size:1.2rem;color:var(--gold);margin:12px 0;min-height:32px">Watch closely…</div>'
  ...
  function nextRound() {
    ...
    document.getElementById('cg-score').textContent =
      'Round: ' + currentRound + '/' + totalRounds + ' | Score: ' + correctRounds

...
G.showOrganise = function () {
  ...
  function render() {
    ...
    html +=
      '<div style="color:var(--gray);font-size:0.8rem">Your budget: €' + G.state.budget.toLocaleString() + '</div>'
  ...
  function launchConcert() {
      ...
      var chaosEvents = [
        {
          text:
            '🔥 ' +
            artists[0].name +
            ' set off fireworks inside the venue. The crowd went INSANE. Surprisingly, no one was hurt.',
          bonus: 300
        },
        {
          text: '💀 Rex Phantom crowd-surfed into the mixing desk. Chaos ensued. Surprisingly, everyone loved it.',
          bonus: 300
        },
    ...
    html +=
      '<div style="margin-bottom:4px">👥 Attendance: <strong>' +
